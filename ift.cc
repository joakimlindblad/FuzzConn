...
//%K is sparse symmetric matrix of size numel(S)*numel(S) 
//%
...
/////////////////////////////////////////////////////////////////////////////
//function [FC,S]=ift(S,K), matrix S is written to
/////////////////////////////////////////////////////////////////////////////
void ift(mxxMatrix<double> &S, const mxxSparseMatrix<const double> &K, mxxMatrix<double> &FC)
{
...
int nrhs, const mxArray *prhs[])
{
	...
	plhs[1] = mxDuplicateArray(prhs[0]); //duplicate input matrix as output
	mxxMatrix<double> S(plhs[1]); //we manipulate it
